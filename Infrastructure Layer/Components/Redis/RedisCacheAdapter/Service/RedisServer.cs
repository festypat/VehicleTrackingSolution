...
namespace RedisCacheAdapter.Service
{
    public class RedisServer
    {
        ...
        {
            string host = configuration.GetSection("RedisCacheConfigurations:Host").Value;
            string port = configuration.GetSection("RedisCacheConfigurations:Port").Value;
